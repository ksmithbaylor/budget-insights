...
MozUserSelect:"none",msUserSelect:"none",userSelect:"none"}));s.getAttribute("state")!==q&&(s.setAttribute("state",q),s.setAttribute("type","button"),oa(m,s,{padding:"5px 12px",cursor:"pointer","float":"left",width:"40px",height:"25px",outline:"0px",verticalAlign:"baseline",lineHeight:"0"}),s.setAttribute("title",m._cultureInfo[q+"Text"]),s.innerHTML="<img style='height:95%;' src='"+eb[q].image+"' alt='"+m._cultureInfo[q+"Text"]+"' />"); console.log(m._cultureInfo)}function Ma(){for(var m=null,s=0;s<arguments.length;s++)m=arguments[s],
